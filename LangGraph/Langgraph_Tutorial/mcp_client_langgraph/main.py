...
from model import llm_ollama, llm_openai
from model import OPENAI_MODEL_NAME

# prompt = "Write a short poem about the color blue."
...
#     ("human", prompt)
# ]
# ollama_response = llm_ollama.invoke(messages)

# # OpenAI
# openai_response = llm_openai.chat.completions.create(
...
# print("=== Ollama deepseek-r1:latest Response ===")
# print(ollama_response.content)

# print("\n=== OpenAI gemma3:4b Response ===")
